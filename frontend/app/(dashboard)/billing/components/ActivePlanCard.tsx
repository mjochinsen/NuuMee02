...
const planConfig: Record<string, { icon: string; price: string }> = {
  free: { icon: '⭐', price: 'Free' },
  creator: { icon: '🏆', price: '$29/month' },
  studio: { icon: '💎', price: '$99/month' },
};
...
export function ActivePlanCard({
  ...
  return (
    <div className="border border-[#334155] rounded-2xl p-6 bg-[#0F172A]">
      ...
      <div className="text-[#94A3B8] text-sm mb-1">{config.price}</div>
