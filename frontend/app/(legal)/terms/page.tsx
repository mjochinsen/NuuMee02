  ...
  return (
    <main className="container mx-auto px-6 py-12 max-w-5xl">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-[#94A3B8]">
                ...
                <Link href="/privacy" className="text-[#00F0D9] hover:text-[#00F0D9]/80 underline">
                  Privacy Policy
                </Link>
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-4 text-sm">
        ...
        <Link href="/pricing" className="text-[#00F0D9] hover:text-[#00F0D9]/80">
          Pricing Plans
        </Link>
        <span className="text-[#334155]">•</span>
        <Link href="/support" className="text-[#00F0D9] hover:text-[#00F0D9]/80">
          Support Center
        </Link>
        <span className="text-[#334155]">•</span>
        <Link href="/account" className="text-[#00F0D9] hover:text-[#00F0D9]/80">
          Account Settings
        </Link>
      </div>
    </main>
