    ...
    <main className="min-h-screen flex items-center justify-center px-6 py-12">
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#F1F5F9] mb-3">Account Deleted</h1>
          <p className="text-[#94A3B8] text-xl">We&apos;re sad to see you go</p>
        </div>

        {/* What Happened */}
        <div className="border border-[#334155] rounded-2xl p-8 bg-[#0F172A] mb-8">
          <h2 className="text-[#F1F5F9] font-semibold text-xl mb-4">What happened:</h2>
        ...
        <div className="bg-[#00F0D9]/5 border border-[#00F0D9]/20 rounded-2xl p-8 mb-8">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <h3 className="text-[#F1F5F9] font-semibold">Thank you for trying NuuMee.AI</h3>
          </div>
          ...
          <div className="space-y-3">
            <p className="text-[#94A3B8] text-sm">Changed your mind? You can always create a new account.</p>
            <Link href="/signup">
