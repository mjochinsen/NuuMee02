            ...
            {[
              {
                ...
                description: 'Use stock avatars or train a custom brand spokesperson.',
              },
              {
                step: 2,
                icon: FileText,
                title: 'Input Your Message',
                description: 'Scripts, bullet points, or AI-generated content.',
              },
              {
                step: 3,
                icon: Layers,
                title: 'Generate at Scale',
                description: 'Produce unlimited variations for any campaign.',
              },
            ].map((item) => (
