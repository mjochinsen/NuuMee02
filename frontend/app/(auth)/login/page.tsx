  ...
  return (
    <div className="border border-[#334155] rounded-2xl p-8 bg-[#1E293B]/80 backdrop-blur-sm">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="text-[#F1F5F9] text-2xl font-bold mb-2">Welcome back</h1>
        <p className="text-[#94A3B8]">Sign in to continue creating</p>
      </div>
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-[#1E293B] px-2 text-[#94A3B8]">or continue with email</span>
        </div>
      </div>
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/forgot-password" className="text-sm text-[#00F0D9] hover:text-[#00F0D9]/80">
            Forgot password?
          </Link>
        </div>
      ...
      <p className="mt-6 text-center text-[#94A3B8]">
        ...
        <Link href="/signup" className="text-[#00F0D9] hover:text-[#00F0D9]/80 font-medium">
          Sign up
        </Link>
      </p>
    </div>
