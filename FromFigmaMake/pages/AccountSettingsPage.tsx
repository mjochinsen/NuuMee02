...
export default function AccountSettingsPage() {
  ...
  const handleRequestDataExport = () => {
    toast.info('ℹ️ Data export requested. Check your email in 10 minutes.');
  };
                    ...
                    <div className="flex items-center gap-3">
                      <Switch
                        ...
                        onCheckedChange={(checked) => {
                          ...
                          toast.success('✅ Browser notification preference updated');
                        }}
                      />
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-[#1E293B] border border-[#334155] rounded-lg p-4">
                      <p className="text-[#94A3B8] text-sm">
                        ℹ️ Webhooks send POST requests when events occur
                      </p>
                    </div>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-[#1E293B] border border-[#334155] rounded-lg p-4">
                      <p className="text-[#94A3B8] text-sm">
                        ℹ️ We collect: feature usage, error reports, performance metrics
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-[#1E293B] border border-[#334155] rounded-lg p-4">
                      <p className="text-[#94A3B8] text-sm">
                        ℹ️ Export will be ready in ~10 minutes. We'll email you a link.
                      </p>
                    </div>
                    <p className="text-[#94A3B8] text-sm">
