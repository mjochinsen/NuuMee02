  ...
  return (
    <main className="min-h-[80vh] flex items-center justify-center px-6 py-12">
      <div className="text-center max-w-2xl mx-auto">
        ...
        <h1 className="text-[#F1F5F9] mb-2">Scene Missing</h1>
        
        {/* 404 Display */}
        <div className="mb-6">
          <span className="text-7xl md:text-8xl bg-gradient-to-r from-[#00F0D9] to-[#3B1FE2] bg-clip-text text-transparent">
            404
          </span>
        </div>

        <h2 className="text-[#F1F5F9] text-2xl md:text-3xl mb-4">
