...
export default function DocumentationPage() {
  ...
  return (
    <main className="container mx-auto px-6 py-12 max-w-7xl">
      <div className="mb-12">
        <h1 className="text-[#F1F5F9] mb-4">Documentation</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {sections.map((section) => (
          ...
          >
            ...
            <h3 className="text-[#F1F5F9] mb-2 group-hover:text-[#00F0D9] transition-colors">
              {section.title}
            </h3>
      ...
      <div className="border border-[#334155] rounded-2xl p-8 bg-[#0F172A] mt-12">
        <h2 className="text-[#F1F5F9] mb-6">Quick Links</h2>
