...
export default function HomePage() {
  ...
  return (
    <div className="w-full">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-12">
            ...
            <h1 className="text-[#F1F5F9] mb-6 text-5xl md:text-6xl lg:text-7xl max-w-5xl mx-auto leading-tight">
      ...
      <section className="py-16 border-y border-[#334155] bg-[#0F172A]/50">
        <div className="container mx-auto px-6">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 opacity-50">
            <div className="text-[#F1F5F9] text-2xl">YouTube</div>
            <div className="text-[#F1F5F9] text-2xl">TikTok</div>
            <div className="text-[#F1F5F9] text-2xl">Instagram</div>
            <div className="text-[#F1F5F9] text-2xl">LinkedIn</div>
            <div className="text-[#F1F5F9] text-2xl">Studios</div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gradient-to-b from-[#0F172A] to-[#1E293B]">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-[#F1F5F9] text-4xl md:text-5xl mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="relative">
              <div className="border border-[#334155] rounded-2xl p-8 bg-[#0F172A] text-center h-full">
                <div className="w-16 h-16 rounded-full bg-gradient-to-r from-[#00F0D9] to-[#3B1FE2] flex items-center justify-center mx-auto mb-6 text-2xl text-white">
                  1
                </div>
                <h3 className="text-[#F1F5F9] text-xl mb-4">Upload Character</h3>
            ...
            <div className="relative">
              <div className="border border-[#334155] rounded-2xl p-8 bg-[#0F172A] text-center h-full">
                ...
                <h3 className="text-[#F1F5F9] text-xl mb-4">Upload Video</h3>
            ...
            <div className="border border-[#334155] rounded-2xl p-8 bg-[#0F172A] text-center">
              ...
              <h3 className="text-[#F1F5F9] text-xl mb-4">Generate Magic</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto mb-12">
            {filteredUseCases.map((useCase, index) => (
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-[#F1F5F9] text-xl mb-2">{useCase.title}</h3>
      ...
      <section className="py-24 bg-gradient-to-b from-[#1E293B] to-[#0F172A]">
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="border-2 border-[#334155] rounded-2xl overflow-hidden bg-[#1E293B] mb-8">
              <div className="relative aspect-video">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=1200&h=675&fit=crop"
                  alt="Before and after comparison"
                  className="w-full h-full object-cover"
                />
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="bg-black/70 px-8 py-4 rounded-xl backdrop-blur-sm">
                    <p className="text-white text-sm mb-2">Interactive Before/After Slider</p>
                    <div className="flex items-center gap-4 text-[#F1F5F9]">
                      <span>BEFORE</span>
                      <div className="w-24 h-1 bg-gradient-to-r from-[#00F0D9] to-[#3B1FE2] rounded-full relative">
                        <div className="absolute top-1/2 left-1/2 -translate-y-1/2 w-4 h-4 bg-white rounded-full"></div>
                      </div>
                      <span>AFTER</span>
                    </div>
                  </div>
            ...
            <div className="border border-[#334155] rounded-2xl p-8 bg-[#0F172A]">
              <h3 className="text-[#F1F5F9] text-2xl mb-4">Case Study: Fashion Brand X</h3>
              <p className="text-[#94A3B8] text-lg mb-6">
                "We replaced our model in 200 product videos in 2 hours. Would've taken 2 weeks and $100K to reshoot."
              </p>
              <Button 
                variant="link"
                className="text-[#00F0D9] hover:text-[#00F0D9]/80 p-0"
              >
      ...
      <section className="py-24 bg-[#0F172A]">
        <div className="container mx-auto px-6">
          ...
          <div className="text-center">
            ...
            <div className="mt-12">
              <p className="text-[#94A3B8] mb-6">Join thousands of successful creators</p>
              <Link to="/create">
                <Button 
                  size="lg"
                  className="bg-gradient-to-r from-[#00F0D9] to-[#3B1FE2] hover:opacity-90 text-white px-8"
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="border border-[#334155] rounded-2xl p-8 bg-[#0F172A] text-center">
              ...
              <h3 className="text-[#F1F5F9] text-xl mb-3">Pixel-Perfect Replacement</h3>
              <p className="text-[#94A3B8]">
            ...
            <div className="border border-[#334155] rounded-2xl p-8 bg-[#0F172A] text-center">
              ...
              <h3 className="text-[#F1F5F9] text-xl mb-3">Lightning Fast</h3>
              <p className="text-[#94A3B8]">
            ...
            <div className="border border-[#334155] rounded-2xl p-8 bg-[#0F172A] text-center">
              ...
              <h3 className="text-[#F1F5F9] text-xl mb-3">Full Motion Preservation</h3>
              <p className="text-[#94A3B8]">
            ...
            <div className="border border-[#334155] rounded-2xl p-8 bg-[#0F172A] text-center">
              ...
              <h3 className="text-[#F1F5F9] text-xl mb-3">Secure & Private</h3>
              <p className="text-[#94A3B8]">
            ...
            <div className="border border-[#334155] rounded-2xl p-8 bg-[#0F172A] text-center">
              ...
              <h3 className="text-[#F1F5F9] text-xl mb-3">Pro Quality Output</h3>
              <p className="text-[#94A3B8]">
            ...
            <div className="border border-[#334155] rounded-2xl p-8 bg-[#0F172A] text-center">
              ...
              <h3 className="text-[#F1F5F9] text-xl mb-3">Affordable Pricing</h3>
              <p className="text-[#94A3B8]">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="border border-[#334155] rounded-2xl p-8 bg-[#1E293B]">
              <h3 className="text-[#F1F5F9] text-2xl mb-2">Free</h3>
              <div className="mb-6">
                <span className="text-4xl text-[#F1F5F9]">$0</span>
              </div>
            ...
            <div className="border-2 border-[#00F0D9] rounded-2xl p-8 bg-[#1E293B] relative">
              ...
              <h3 className="text-[#F1F5F9] text-2xl mb-2">Creator</h3>
              <div className="mb-6">
                <span className="text-4xl text-[#F1F5F9]">$29</span>
            ...
            {/* Studio Plan */}
            <div className="border border-[#334155] rounded-2xl p-8 bg-[#1E293B]">
              <h3 className="text-[#F1F5F9] text-2xl mb-2">Studio</h3>
              <div className="mb-6">
                <span className="text-4xl text-[#F1F5F9]">$99</span>
                <span className="text-[#94A3B8]">/mo</span>
              </div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-start gap-2 text-[#94A3B8]">
      ...
      {/* Final CTA */}
      <section className="py-24 bg-gradient-to-b from-[#1E293B] via-[#0F172A] to-[#0F172A] relative overflow-hidden">
        {/* Background effects */}
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-[#F1F5F9] text-4xl md:text-5xl lg:text-6xl mb-6">
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-8 text-[#94A3B8]">
              <Link to="/price" className="hover:text-[#00F0D9] transition-colors">
                View Pricing
              </Link>
              <span>|</span>
