  ...
  return (
    <main className="container mx-auto px-6 py-12 max-w-7xl">
      <div className="text-center mb-12">
        <h1 className="text-[#F1F5F9] mb-4">What Our Users Say</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
        {stats.map((stat) => (
          <div key={stat.label} className="border border-[#334155] rounded-2xl p-6 bg-[#0F172A] text-center">
            <div className="text-[#F1F5F9] text-3xl mb-2 bg-gradient-to-r from-[#00F0D9] to-[#3B1FE2] bg-clip-text text-transparent">
              {stat.value}
            </div>
        ...
        {testimonials.map((testimonial) => (
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-[#F1F5F9]">{testimonial.name}</div>
      ...
      <div className="border border-[#334155] rounded-2xl p-8 bg-[#0F172A] text-center mt-12">
        <h2 className="text-[#F1F5F9] mb-4">Ready to Join Them?</h2>
        <p className="text-[#94A3B8] mb-6 max-w-2xl mx-auto">
          Start creating amazing videos with AI character replacement today.
        </p>
        <button className="bg-gradient-to-r from-[#00F0D9] to-[#3B1FE2] hover:opacity-90 text-white px-8 py-3 rounded-lg transition-opacity">
          Get Started Free
        </button>
      </div>
    </main>
